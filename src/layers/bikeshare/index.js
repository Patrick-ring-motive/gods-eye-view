...
export function createBikeshareLayer({
  services,
  source
}) {
  ...
  return Object.assign({},
    ...
    parts.ingestion?.methods, {
      createBikeshareSelectedOverlayEntry: parts.selection.createBikeshareSelectedOverlayEntry,
      _setBikeshareSelectionStateForTest: parts.testing._setBikeshareSelectionStateForTest,
      _selectBikeshareStationForTest: parts.testing._selectBikeshareStationForTest,
      _clearBikeshareSelectionForTest: parts.testing._clearBikeshareSelectionForTest,
    },
  );
}
export {
